...
#         print("\ntest_guest_can_login #1")
#         assert True
#
#     # номер 2
#     @pytest.mark.regression
#     def test_guest_can_add_book_from_catalog_to_basket(self, browser):
#         print("\ntest_guest_can_add_book_from_catalog_to_basket #2")
#         assert True
...
#         print("\ntest_guest_can_go_to_payment_page #3")
#         assert True
#
#     # номер 4
#     @pytest.mark.smoke
#     def test_guest_can_see_total_price(self, browser):
#         print("\ntest_guest_can_see_total_price #4")
#         assert True
#
#
# @pytest.mark.skip
...
#         print("\ntest_guest_can_add_book_to_basket #5")
#         assert True
#
#     # номер 6
#     @pytest.mark.regression
#     def test_guest_can_see_book_price(self, browser):
#         print("\ntest_guest_can_see_book_price #6")
#         assert True
#
#
# # номер 7
...
#     print("\ntest_guest_can_open_gadget_catalogue #7")
#     assert True
